---
title: Prohibited and restricted export codes
excerpt: >-
  Explore the classifications and conditions for prohibited and restricted
  export codes, including examples and advisory notes.
deprecated: false
hidden: false
icon: far fa-closed-captioning-slash
link:
  new_tab: false
metadata:
  title: ''
  description: >-
    International and prohibited export codes refer to specific classifications
    that govern which items can be exported from a country and under what
    conditions.
  robots: index
---
