...
<table>
  <tr>
    ...
    <thstyle="background-color: lightgray;">Milestone Order</th>
    <thstyle="background-color: lightgray;">Tracking Event Code</th>
    <thstyle="background-color: lightgray;">Tracking Event Name</th>
  </tr>
  <tr>
