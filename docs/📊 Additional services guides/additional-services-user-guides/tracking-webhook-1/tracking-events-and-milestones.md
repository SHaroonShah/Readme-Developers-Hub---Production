...
<table>
    <tr>
        ...
        <th>Intersoft tracking events mapped to milestone</th>
    </tr>
    <tr>
        <td rowspan="2">It's on it's way</td>
        <td>1</td>
        <td>PSRE</td>
    ...
    <tr>
        <td rowspan="2">Out for delivery</td>
        <td>4</td>
        <td>POFD</td>
    ...
    <tr>
        <td rowspan="2">Part Delivered</td>
        <td>6</td>
        <td>DPAR</td>
