...
<Cards>
  <Card title="Guidelines for choosing strong password" href="https://docs.intersoftsapient.net/v4.04/docs/guidelines-for-choosing-strong-password#/versions" icon="fa-solid fa-list" target="_blank">
