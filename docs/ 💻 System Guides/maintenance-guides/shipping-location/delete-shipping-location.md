  ...
  <Tab title="Delete via SAPIENT UI">
    ...
    <ToggleList>
      ...
      <ToggleListItem title={<strong>2. Select location to delete</strong>} icon="fa-rocket">
        ...
        <Image align="center" border={true} src="https://files.readme.io/0ffbf35c04a6aa2b82329f91bca4df861fae2511cfbe07feeee4d9e97827d8c5-Edit_shippig_location_option.png" caption="Selecting option to add shipping location" />
      ...
      <ToggleListItem title={<strong>3. Delete location </strong>} icon="fa-rocket">
        ...
        <Image align="center" border={true} src="https://files.readme.io/bd3538aec38b70a7d69715426fca677ddc2922db2b942448fce828b6357e2cad-Deleting_shipping_location.png" caption="Entering location details" />
