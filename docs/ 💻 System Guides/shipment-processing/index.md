...
excerpt: >-
  The shipment processing feature is designed to facilitate the management and
...
<Cards columns={3}>
  ...
  <Card title="View Manifest History" href="https://docs.intersoftsapient.net/v4.04/docs/manifest-history#/versions" icon="fa-solid fa-file">
