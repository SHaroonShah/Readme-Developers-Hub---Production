...
> 💡 *Tip*
>
> *For more information on how to populate the required fields, refer to[API References](https://docs.intersoftsapient.net/reference/post_v4-shipments-rm) the section.*
