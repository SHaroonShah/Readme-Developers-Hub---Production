...
next:
  description: ''
---
If you want to create the <<glossary:shipments>> and print the <<glossary:labels>>, then use the **Process** action in your [Create Shipment](https://docs.intersoftsapient.net/reference/post_v4-shipments-rm) request. In this case, shipments are ready to be manifested at any time you want. Additionally, this action also reduces the number API calls you need to make.

If your warehouse simultaneously picks, packs and sticks labels to shipments, then, if required,  labels and <<glossary:CN23>> are returned in the successful response.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/f762106c6e0adca64fd03cbc168faecdddceccf9adcb67b8bb963988cc3090bc-Process_flow.png",
        "",
        "Workflow for creating shipments with the Process action"
      ],
      "align": "center",
