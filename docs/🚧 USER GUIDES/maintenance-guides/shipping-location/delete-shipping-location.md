...
<Image alt="Selecting option to add shipping location" align="center" border={true} src="https://files.readme.io/0ffbf35c04a6aa2b82329f91bca4df861fae2511cfbe07feeee4d9e97827d8c5-Edit_shippig_location_option.png">
  Selecting option to delete shipping location
</Image>
...
<Image alt="Entering location details" align="center" border={true} src="https://files.readme.io/bd3538aec38b70a7d69715426fca677ddc2922db2b942448fce828b6357e2cad-Deleting_shipping_location.png">
  Deleting shipping location
</Image>

4. In the confirmation dialog that appears, select **Yes** to confirm your action.

<Image alt="Confirming deletion" align="center" width="350px" border={true} src="https://files.readme.io/a6e38fbaadee4529ebe22646e35a12534d4a944a8bfb768a243d02380f082af2-Confirming_account_deletion.png">
  Confirming deletion
</Image>
