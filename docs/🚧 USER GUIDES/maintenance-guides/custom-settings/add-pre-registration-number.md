...
metadata:
  title: ''
  description: >-
    A pre-registration number is often required for certain shipments,
    especially when dealing with customs or compliance-related processes. This
    number serves as an identifier for businesses that engage in international
    shipping and may need to meet specific regulatory requirements before
