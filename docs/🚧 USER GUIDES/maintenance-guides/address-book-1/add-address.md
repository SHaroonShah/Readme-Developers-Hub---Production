...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/145195adcbdbf39b1faea51d1afa71dcc10a408409060a05d02bc12fb48a8630-Address_option.png",
        "",
        "Accessing address book"
      ],
      "align": "center",
      "border": true,
      "caption": "Accessing address book"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/8ae2dc77ad318b15a6820eafa0a2e377d27bdb399930a943b1234114ad63a4fc-Add_address_option.png",
        "",
        "Accessing option to add address"
      ],
      "align": "center",
      "border": true,
      "caption": "Accessing option to add address"
    }
  ]
}
[/block]
...
> 📘 _Note_
> 
> _If the Address id is not provided, then the system allocates one by default._
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/023cc3556d6fb1c94f4a6342c6ec4bd549475a0e67cdde381a4aaa8fca5ac29a-Address_name_block.png",
        "",
        "Adding address name"
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/7c75448e34131d863e8b073a1c6afc592b7938e71b88744e044df22b9f7f1cf7-Address_details_block_2.png",
        "",
...
|   **What3Words**   | Enter the  <<glossary:What3words>> for your address to be able to get identified within the resolution of about 3 meters. |
...
> 📘 _Note_
> 
> _Addresses can be added and managed via API. To learn more on how to add an address via API, refer to the [API References](https://docs.intersoftsapient.net/reference/post_v4-addresses) section._