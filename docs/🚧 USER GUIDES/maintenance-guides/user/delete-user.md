...
next:
  description: ''
---
In SAPIENT, you can delete the users when they are no longer required to reduce potential security risks by ensuring that only authorised personnel have access to sensitive shipping information and operations. Additionally, this process helps streamline user management by removing inactive or unnecessary accounts, thereby improving system performance and clarity.

To delete a user in SAPIENT, follow the steps as explained in the following procedure.
