...
> 🚧 *Important*
>
> *Prior to adding The Delivery Group tracking account, make sure you have completed the following prerequisites:*
>
> 1. *Enabled the[label integration](https://docs.intersoftsapient.net/docs/integration-activation) with The Delivery Group.*
> 2. *Enabled the[tracking integration](https://docs.intersoftsapient.net/docs/integration-activation) with The Delivery Group.*
