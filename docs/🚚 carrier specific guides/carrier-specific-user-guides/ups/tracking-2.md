...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/c3f6098979696b25cbdbe26921658742edef4520e983ae8c70cbe6f689e4aadf-Tracking_accounts_tab.png",
        "",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/c2f04a8e6b4e985e203082e192cfe4d35f0702aa38fa593bb2440e490295dd3a-Add_tracking_account_button_UPS.png",
        "",
...
| **Shipping Account\*** | From the dropdown menu, select the <<glossary:shipping account>> for which you want to receive tracking. |
...
Once done, the UPS tracking account is added successfully and appears in the **Tracking Accounts** list. You can now receive the tracking information on your <<glossary:shipments>>.