...
* **Manifest/Sales Order Summary**. The <Glossary>manifest</Glossary> must be produced by calling the [Manifest Shipments](https://docs.intersoftsapient.net/reference/post_v4-manifests-carriercode) API request for the labels being supplied in the test pack.
