...
* [Update Status](https://docs.intersoftsapient.net/reference/put_v4-shipments-status): to cancel/void a current shipping label. This can only be used before a <Glossary>shipment</Glossary> has been confirmed by being manifested.
...
* [Manifest Shipments](https://docs.intersoftsapient.net/reference/post_v4-manifests-carriercode): to closeout shipments, which produces the collection <Glossary>manifest</Glossary> to be handed over to the driver and triggers electronic <Glossary>pre-advice</Glossary> and billing data to be sent to the <Glossary>carrier</Glossary>. This must be done before your <Glossary>shipment</Glossary> enter Royal Mail network.  Not doing it may result in multiple issues such as delays, missing tracking, lack of notifications for your end consumers, surcharges, and others.
