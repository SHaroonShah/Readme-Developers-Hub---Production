...
next:
  description: ''
---
Once you have created the DX Freight <<glossary:shipping account>>, make sure you have the correct information before you start using it to ship with DX Freight.
...
4. Although, the Intersoft DX Freight integration is approved by the <<glossary:carrier>>, it is recommended to create a few test labels with services you will be using and share the <<glossary:labels>> with the carrier for review to avoid any discrepancies.
