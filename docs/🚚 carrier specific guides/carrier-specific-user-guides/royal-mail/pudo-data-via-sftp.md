...
| Filed #   | Field Name | Comments |
| --- | --- | --- | --- | --- |
| 1   | Record Type | This will always be D |
| 2   | Office Type | Represents the values of either CSP (for RM Customer Service Points), POL(for Post Offices), and PSH (Parcel Shop) for Collect + stores. |
| 3   | Office number/refence | Represents the unique identifier for the office. |
| 4   | Office Name | Represents the name of the office. |
| 5   | Address Line 1 | Represents the first line of address. |
| 6   | Address Line 2 (if relevant) | Represents the second line of address, if applicable. |
| 7   | Address Line 3 (if relevant) | Represents the third line of address, if applicable. |
| 8   | Address Line 4 (if relevant) | Represents the fourth line of address, if applicable. |
| 9   | Address Line 5 (if relevant) | Represents the fifth line of address, if applicable. |
| 10  | Town | Represents the name of the town. |
| 11  | Postcode | Represents the postcode of the location. |
| 12  | Longitude (if available) | Represents the longitude value for the office location, if applicable. |
| 13  | Latitude (if available) | Represents the latitude value for the office location, if applicable. |
| 14  | Monday Open 1 | Represents the first opening time on Monday in the hh:mm (24hr clock) format. |
| 15  | Monday Open 2 | Represents the second opening time on Monday in the hh:mm (24hr clock) format.<br></br>_Note: This record is left blank if the office has only one opening time._ |
| 16  | Monday Open 3 | Represents the third opening time on Monday in the hh:mm (24hr clock) format.<br></br>_Note: This record is left blank if the office only has one or two opening times._ |
| 17  | Monday Close 1| Represents the first closing time on Monday in the hh:mm (24hr clock) format. |
| 18  | Monday Close 2| Represents the second closing time on Monday in the hh:mm (i24hr clock) format.<br></br>_Note: This record is left blank if the office has only one closing time._ |
| 19  | Monday Close 3| Represents the third closing time on Monday in the hh:mm (24hr clock) format.<br></br>_Note: This record is left blank if the office has only one or two closing times._ |
| 20  | Tuesday Open 1| First opening time on Tuesday in format hh:mm (in 24hr clock format) |
| 21  | Tuesday Open 2| Second opening time on Tuesday in format hh:mm (in 24hr clock format) (will be blank if office only has one opening time) |
| 22  | Tuesday Open 3| Third opening time on Tuesday in format hh:mm (in 24hr clock format) (will be blank if office only has one or two opening times) |
| 23  | Tuesday Close 1| First Closing time on Tuesday in format hh:mm (in 24hr clock format) |
| 24  | Tuesday Close 2| Second Closing time on Tuesday in format hh:mm (in 24hr clock format) (will be blank if office only has one Closing time) |
| 25  | Tuesday Close 3| Third Closing time on Tuesday in format hh:mm (in 24hr clock format) (will be blank if office only has one or two Closing times) |
| 26  | Wednesday Open 1| First opening time on Wednesday in format hh:mm (in 24hr clock format) |
| 27  | Wednesday Open 2 | Second opening time on Wednesday in format hh:mm (in 24hr clock format) (will be blank if office only has one opening time) |
| 28  | Wednesday Open 3| Third opening time on Wednesday in format hh:mm (in 24hr clock format) (will be blank if office only has one or two opening times) |
| 29  | Wednesday Close 1| First Closing time on Wednesday in format hh:mm (in 24hr clock format) |
| 30  | Wednesday Close 2| Second Closing time on Wednesday in format hh:mm (in 24hr clock format) (will be blank if office only has one Closing time) |
| 31  | Wednesday Close 3| Third Closing time on Wednesday in format hh:mm (in 24hr clock format) (will be blank if office only has one or two Closing times) |
| 32  | Thursday Open 1 |First opening time on Thursday in format hh:mm (in 24hr clock format) |
| 33  | Thursday Open 2 | Second opening time on Thursday in format hh:mm (in 24hr clock format) (will be blank if office only has one opening time) |
| 34  | Thursday Open 3 |Third opening time on Thursday in format hh:mm (in 24hr clock format) (will be blank if office only has one or two opening times) |
| 35  | Thursday Close 1 | First Closing time on Thursday in format hh:mm (in 24hr clock format) |
| 36  | Thursday Close 2 | Second Closing time on Thursday in format hh:mm (in 24hr clock format) (will be blank if office only has one Closing time) |
| 37  | Thursday Close 3 | Third Closing time on Thursday in format hh:mm (in 24hr clock format) (will be blank if office only has one or two Closing times) |
| 38  | Friday Open 1 | First opening time on Friday in format hh:mm (in 24hr clock format) |
| 39  | Friday Open 2 | Second opening time on Friday in format hh:mm (in 24hr clock format) (will be blank if office only has one opening time) |
| 40  | Friday Open 3 | Third opening time on Friday in format hh:mm (in 24hr clock format) (will be blank if office only has one or two opening times) |
| 41  | Friday Close 1 | First Closing time on Friday in format hh:mm (in 24hr clock format) |
| 42  | Friday Close 2 | Second Closing time on Friday in format hh:mm (in 24hr clock format) (will be blank if office only has one Closing time) |
| 43  | Friday Close 3 | Third Closing time on Friday in format hh:mm (in 24hr clock format) (will be blank if office only has one or two Closing times) |
| 44  | Saturday Open 1 | First opening time on Saturday in format hh:mm (in 24hr clock format) |
| 45  | Saturday Open 2 |  Second opening time on Saturday in format hh:mm (in 24hr clock format) (will be blank if office only has one opening time) |
| 46  | Saturday Open 3 |  Third opening time on Saturday in format hh:mm (in 24hr clock format) (will be blank if office only has one or two opening times) |
| 47  | Saturday Close 1 |  First Closing time on Saturday in format hh:mm (in 24hr clock format) |
| 48  | Saturday Close 2 | Second Closing time on Saturday in format hh:mm (in 24hr clock format) (will be blank if office only has one Closing time) |
| 49  | Saturday Close 3 | Third Closing time on Saturday in format hh:mm (in 24hr clock format) (will be blank if office only has one or two Closing times) |
| 50  | Sunday Open 1 | First opening time on Sunday in format hh:mm (in 24hr clock format) |
| 51  | Sunday Open 2 | Second opening time on Sunday in format hh:mm (in 24hr clock format) (will be blank if office only has one opening time) |
| 52  | Sunday Open 3 | Third opening time on Sunday in format hh:mm (in 24hr clock format) (will be blank if office only has one or two opening times) |
| 53  | Sunday Close 1 | First Closing time on Sunday in format hh:mm (in 24hr clock format) |
| 54  | Sunday Close 2 | Second Closing time on Sunday in format hh:mm (in 24hr clock format) (will be blank if office only has one Closing time) |
| 55  | Sunday Close 3 | Third Closing time on Sunday in format hh:mm (in 24hr clock format) (will be blank if office only has one or two Closing times) |
| 56  | Wednesday Open 1 | First opening time on Wednesday in format hh:mm (in 24hr clock format) |
| 57  | Wednesday Open 2 | Second opening time on Wednesday in format hh:mm (in 24hr clock format) (will be blank if office only has one opening time) |
| 58  | Wednesday Open 3 | Third opening time on Wednesday in format hh:mm (in 24hr clock format) (will be blank if office only has one or two opening times) |
| 59  | Wednesday Close 1 | First Closing time on Wednesday in format hh:mm (in 24hr clock format) |
| 60  | Wednesday Close 2 | Second Closing time on Wednesday in format hh:mm (in 24hr clock format) (will be blank if office only has one Closing time) |
| 61  | Wednesday Close 3 | Third Closing time on Wednesday in format hh:mm (in 24hr clock format) (will be blank if office only has one or two Closing times) |
| 62  | Thursday Open 1 |  First opening time on Thursday in format hh:mm (in 24hr clock format) |
| 63  | Thursday Open 2 | Second opening time on Thursday in format hh:mm (in 24hr clock format) (will be blank if office only has one opening time) |
| 64  | Thursday Open 3 | Third opening time on Thursday in format hh:mm (in 24hr clock format) (will be blank if office only has one or two opening times) |
| 65  | Thursday Close 1 | First Closing time on Thursday in format hh:mm (in 24hr clock format) |
| 66  | Thursday Close 2 | Second Closing time on Thursday in format hh:mm (in 24hr clock format) (will be blank if office only has one Closing time) |
| 67  | Thursday Close 3 | Third Closing time on Thursday in format hh:mm (in 24hr clock format) (will be blank if office only has one or two Closing times) |
| 68  | Friday Open 1 |  First opening time on Friday in format hh:mm (in 24hr clock format) |
| 69  | Friday Open 2 |  Second opening time on Friday in format hh:mm (in 24hr clock format) (will be blank if office only has one opening time) |
| 70  | Friday Open 3 |  Third opening time on Friday in format hh:mm (in 24hr clock format) (will be blank if office only has one or two opening times) |
| 71  | Friday Close 1 | First Closing time on Friday in format hh:mm (in 24hr clock format) |
| 72  | Friday Close 2 |  Second Closing time on Friday in format hh:mm (in 24hr clock format) (will be blank if office only has one Closing time) |
| 73  | Friday Close 3 |  Third Closing time on Friday in format hh:mm (in 24hr clock format) (will be blank if office only has one or two Closing times) |
| 74  | Saturday Open 1 | First opening time on Saturday in format hh:mm (in 24hr clock format) |
| 75  | Saturday Open 2 |  Second opening time on Saturday in format hh:mm (in 24hr clock format) (will be blank if office only has one opening time) |
| 76  | Saturday Open 3 | Third opening time on Saturday in format hh:mm (in 24hr clock format) (will be blank if office only has one or two opening times) |
| 77  | Saturday Close 1 | First Closing time on Saturday in format hh:mm (in 24hr clock format) |
| 78  | Saturday Close 2 |  Second Closing time on Saturday in format hh:mm (in 24hr clock format) (will be blank if office only has one Closing time) |
