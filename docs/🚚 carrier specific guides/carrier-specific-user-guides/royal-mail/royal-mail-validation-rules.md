...
<Accordion title="International NDX shipments with DDU incoterm" icon="fa-solid fa-shield-check">
  **Scenario description**: International non-document (<Glossary>NDX</Glossary>) shipments using <Glossary>DDU</Glossary> incoterm.
  ...
  <table>
    ...
    <tr>
      <td rowspan="5"><strong>Shipper > Address</strong></td> <Banner isInline={true} message="" color="#ffb600" textColor="#ffffff" fontSize="14px" fontWeight="bold" />
      <td>ContactName</td>
    </tr>
    ...
    <Banner colspan="2" isInline={true} message="" color="#ffb600" textColor="#ffffff" fontSize="14px" fontWeight="bold" />
