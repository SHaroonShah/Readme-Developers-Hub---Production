...
<Accordion title="International NDX shipments with DDU incoterm" icon="fa-solid fa-shield-check">
  **Scenario description**: International non-document (<Glossary>NDX</Glossary>) shipments using <Glossary>DDU</Glossary> incoterm.
  ...
  <table>
    ...
    <tr>
      <td colspan="2">
        <Banner isInline={true} color="#ffb600" textColor="" fontSize="" fontWeight="" />
      </td>
    </tr>
...
<table>
  ...
  <tr>
    <td colspan="2">
      <Banner isInline={true} color="#ffb600" textColor="" fontSize="" fontWeight="bold" />
    </td>
  </tr>
  ...
  <tr>
    <td colspan="2">
      <Banner isInline={true} message="" color="#ffb600" textColor="" fontSize="" fontWeight="bold" />
    </td>
  </tr>
