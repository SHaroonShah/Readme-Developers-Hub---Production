...
<Image alt="Accessing API access management" align="center" border={true} src="https://files.readme.io/ed20103-image.png">
  Accessing API access management
</Image>

3. On the page that opens, select **Add API User**.

<Image alt="Selecting option to add API user " align="center" border={true} src="https://files.readme.io/60673e2-image.png">
...
<Image alt="Adding API user" align="center" border={true} src="https://files.readme.io/3e31ffe-image.png">
  Adding API user
</Image>
