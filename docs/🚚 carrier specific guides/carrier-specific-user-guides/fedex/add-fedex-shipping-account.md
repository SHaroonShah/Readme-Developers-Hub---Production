  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        *`Note`: You can use the**Sandbox** account for testing the integration and generating test label to ensure whether the integration is configured correctly or not.*
      </td>
    </tr>
