...
* **Signature options**: Enhanced signature options include:
  * **Adult signature**: To obtain a signature from any person of legal age at the delivery address, subject to the provision of a valid ID. If no one qualified to sign is available, an attempt to redeliver the package on another date. Legal age will vary depending on the destination country/territory and is governed by local legal age of an adult, not the legal age to purchase specific products.
