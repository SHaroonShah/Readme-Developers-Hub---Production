...
|              Element              | Description                                                                                                                                                                                                                                                                                  |
| :-------------------------------: | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
|        **Customer Name**\*        | Enter the name of the company or organisation registered with FedEx.                                                                                                                                                                                                                         |
|           **Country**\*           | From the dropdown menu, select the country in which the customer resides.                                                                                                                                                                                                                    |
|           **Address**\*           | Enter the first line of the customer's address, typically including the street address or location where the customer is based. This is important for accurate validation of the customer details.                                                                                           |
