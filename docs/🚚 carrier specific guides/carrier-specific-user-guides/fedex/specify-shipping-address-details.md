...
metadata:
  robots: index
---
After [confirming the FedEx EULA](https://docs.intersoftsapient.net/docs/confirm-fedex-end-user-license-agreement#/), at the **Shipping Address** stage, you can specify the shipping address details so that the system can validate and match it with the addresses stored in the FedEx system.
...
|           **Country**\*           | From the dropdown menu, select the country in which the customer resides.                                                                                                                                                                                                                    |
|           **Address**\*           | Enter the first line of the customer's address, typically including the street address or location where the customer is based. This is important for accurate delivery and communication.                                                                                                   |
...
|             **County**            | Enter the sate of the county where the customer is based.                                                                                                                                                                                                                                    |
