          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                *`Note`: ETD is only applicable when both the origin and destination countries support it. If either country is unsupported, the shipment will be processed as non-ETD and physical customs documents must be provided.*
              </td>
            </tr>
