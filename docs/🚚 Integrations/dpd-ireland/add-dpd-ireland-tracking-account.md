...
metadata:
  robots: index
---
In SAPIENT, you can add tracking accounts for DPD Ireland to enhance visibility, improve customer interactions, and streamline logistics operations.
...
<Callout icon="🚧" theme="warn">
  ...
  1. _Enabled the&#x20;_[_label integration_](https://docs.intersoftsapient.net/docs/integration-activation)_&#x20;with DPD Ireland._
  2. _Enabled the&#x20;_[_tracking integration_](https://docs.intersoftsapient.net/docs/integration-activation)_&#x20;with DPD Ireland._
  ...
  _If you wish to receive the tracking events via INTERSOFT using the tracking account you have created, make sure it is activated by the DPD Ireland team._
</Callout>

## How to add DPD Ireland tracking account

To add a tracking account for DPD Ireland in SAPIENT, follow the steps in the following procedure.
...
<ToggleList>
  ...
  <ToggleListItem title="3. Enter tracking account details">
    ...
    <Image align="center" border={true} src="https://files.readme.io/132187d592cc67e7de18f937f2caffdd80fe69c89284361d338ba7e4b572dbcb-image.png" width="500px" caption="DPD Ireland tracking account details" />
