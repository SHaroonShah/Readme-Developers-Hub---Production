...
<Callout icon="🚧" theme="warn">
  ...
  1. _Enabled the&#x20;_[_label integration_](https://docs.intersoftsapient.net/docs/integration-activation)_&#x20;with Amazon._
  2. _Enabled the&#x20;_[_tracking integration_](https://docs.intersoftsapient.net/docs/integration-activation)_&#x20;with Amazon._
...
<ToggleList>
  ...
  <ToggleListItem title={<strong>3. Enter account details </strong>} icon="fa-rocket">
    ...
    |         Element        | Description                                                                                                      |
    | :--------------------: | :--------------------------------------------------------------------------------------------------------------- |
    |      **Carrier**\*     | From the dropdown menu, select Amazon as your carrier option.                                                    |
