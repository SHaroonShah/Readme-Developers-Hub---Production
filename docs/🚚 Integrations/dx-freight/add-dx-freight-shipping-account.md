...
<Callout icon="🚧" theme="warn">
  ...
  _Before you can set up a shipping account, make sure you have&#x20;_[_enabled the label integration_](https://docs.intersoftsapient.net/docs/integration-activation)_&#x20;with DX Freight and have already&#x20;_[_created a shipping location_](https://docs.intersoftsapient.net/docs/add-a-shipping-location)_._
</Callout>
...
<Tabs>
  <Tab title="Via SAPIENT UI">
    ...
    <ToggleList>
      ...
      <ToggleListItem title="5. Enter carrier details" icon="truck">
        ...
        <Image align="center" border={true} src="https://files.readme.io/3707bf4d346ea1f22c7d1d3be7bf1d030ca19d84c84998da95fc31d47eb8fc70-carrier_details_block_DX_Freight.png" width="400px" caption="Entering carrier-specific details" />
        <br />
        <AsteridkForMandatoryElements />
  ...
  <Tab title="Via API">
    ...
    <Cards columns="2">
      <Card title="Add Account" href="https://docs.intersoftsapient.net/reference/post_v4-shippingaccounts-dxf" icon="fa-code" target="_blank">
...
<Cards>
  ...
  <Card title="DX Freight Sign-Off" href="https://docs.intersoftsapient.net/docs/dx-freight-sign-off" icon="fa-solid fa-file-signature" target="_blank">
