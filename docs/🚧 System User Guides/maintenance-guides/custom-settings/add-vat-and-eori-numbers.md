...
<Image align="center" alt="Accessing VAT/EORI numbers" border={true} caption="Accessing VAT/EORI numbers" src="https://files.readme.io/d2f5fc850cb7428b8d4fe11242188b656639184480dd01c0e9eebe3cd144f15b-VAT_and_EORI_Numbers_option.png" />

2. In the **VAT and EORI Numbers** page that opens, select ![](https://files.readme.io/cfc581cdc313b6976001d824d376acaf887d052bb884f729d8a58d5d1577f166-Add_VAT-EORI_number_button.png).

<Image align="center" alt="Accessing option to add VAT/EORI number" border={true} caption="Accessing option to add VAT/EORI number" src="https://files.readme.io/97201a3c79a244f53d8d8772dbe7b397a5b6332c1d568a93ecdcad4fc97aa783-Add_vat_and_eori_numbers_option.png" />
...
<Image align="center" alt="Selecting shipping account  " border={true} caption="Selecting shipping account" src="https://files.readme.io/4a14d44448f074b3ef3ae91182eb8f8cee848e50bb9da74ad642b26627ae7259-Shipping_account_block_3.png" />

4. After, in the **VAT/EORI NUMBER** block that appears, enter the necessary information as explained in the following table.
5. <Image align="center" alt="Entering VAT/EORI number and its details" border={true} caption="Entering VAT/EORI number and its details" src="https://files.readme.io/7c7d4e9ebcc049fcd2bd43fac3ce92d73d2f654b832d368199aeb91eb9e830e5-VAT-EORI_Number_block.png" />
...
5. After entering the relevant information, select  ![](https://files.readme.io/c741f8846981e5dbf335f391f4138a7fa3d215a56a14b681ad4fc6ae90bc7dec-Add_VAT-EORI_number_button_2.png).
...
<Callout icon="💡" theme="default">
  ...
  If you want to remove the VAT/EORI, then in the **VAT and EORI Numbers** list, next to the one you want to delete, select ![](https://files.readme.io/0979c7211f5ae99308ba3f765bd083d41949895562626a4f0cc33acd80b30762-Trash_icon.png).

  <Image align="center" alt="Deleting pre-registration number" border={true} caption="Deleting VAT/EORI number" src="https://files.readme.io/18854da926a99e35b6280bbb19445cac623a73a7f01d8cb9df4c99cd2a6fe6e9-Removing_item.png" />
</Callout>
