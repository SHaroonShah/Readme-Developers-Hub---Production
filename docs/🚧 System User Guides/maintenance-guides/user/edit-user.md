...
title: Edit user
excerpt: >-
  Editing a user involves updating user information, such as modifying roles,
...
<ToggleList>
  ...
  <ToggleListItem title={<strong>3. Save changes</strong>} icon="fa-rocket">
    ...
    After entering all the necessary user details, select ![](https://files.readme.io/72a599fc376bd8f5a05777b3fea1ddf73227db655f06d7f14941cabad0cd49ec-Save_changes_button.png).
...
<Callout icon="💡" theme="default">
  ...
  _If needed, from the**Edit User** page, you can also [reset your password](https://docs.intersoftsapient.net/docs/reset-password) by selecting ![](https://files.readme.io/72a7b73173a791e4e2c30096fe1bbd3813b130f0289272639bfd092d33f0fbd9-Reset_password_button.png)._
</Callout>
...
3. After entering all the necessary user details, select ![](https://files.readme.io/72a599fc376bd8f5a05777b3fea1ddf73227db655f06d7f14941cabad0cd49ec-Save_changes_button.png).

Once done, the user is updated successfully.

> 📘 _Note_
>
> _You cannot edit or manage users via API._
