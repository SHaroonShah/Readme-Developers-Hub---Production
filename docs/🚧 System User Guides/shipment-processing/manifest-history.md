...
<ToggleList>
  ...
  In the side navigation panel, select the **Shipment Processing** > **Manifest History** option.<br></br>
...
<br></br>
  ...
  <ToggleListItem title={<strong>3. View results </strong>} icon="fa-rocket">
   ...
   Once filtered, the **Manifest History** table displays the manifested shipments matching your search criteria. The columns displayed in the table are explained in the following table.
    ...
    <Image align="center" border={true} src="https://files.readme.io/7b056fb156b7f9215b4ed0ded2bc9a47f55ba8a45e473c7a72f7609259e26e52-Manifest_history_table.png" alt="Viewing shipments" /><br></br>
