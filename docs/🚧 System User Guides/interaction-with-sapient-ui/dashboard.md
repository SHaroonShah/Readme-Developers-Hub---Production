...
<Cards columns={3}>
  <Card title="Table" href="https://docs.intersoftsapient.net/docs/table" icon="fa-solid fa-table">
  ...
  <Card title="Pagination Bar" href="https://docs.intersoftsapient.net/docs/pagination-bar" icon="fa-solid fa-chevron-left">
    Navigation controls that allow users to browse through multiple pages of content when dealing with large datasets.
  </Card>

  <Card title="Search and Filter Bar" href="https://docs.intersoftsapient.net/docs/search-and-filter-panel" icon="fa-solid fa-search-filter">
