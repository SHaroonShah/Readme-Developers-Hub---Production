...
<Accordion title="SAPIENT release notes - August 31, 2026">
  ...
  # Commercial and Proforma invoice date format update

  To improve clarity and reduce ambiguity across regions using different date conventions, the date format on Commercial and Proforma Invoices generated via the **PrintDocuments API** has been updated from **DD/MM/YYYY to DD Mmm YYYY** (for example, 04 Oct 2026).
  ...
  The updated format helps ensure invoice dates are interpreted consistently regardless of local date formatting standards.

  # Swagger updates

  he query and response field descriptions for the following CORE API endpoints have been updated to improve clarity and help ensure correct API implementation and usage:

  - A**dd, Update, Get and Delete Address**
  - **Get PUDO Locations**
  - **Add, Get and Delete Container**
  - **Get Manifests and Get Manifest Details**
  - **Print Manifest**
  - **Get Carrier Locations**
  - **Unlink Locations**
  - **Get Accounts and Get Associated Accounts**
  - **Update Status**
  - **Get Shipments**
</Accordion>
