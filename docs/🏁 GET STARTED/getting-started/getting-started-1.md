...
<Tabs>
  ...
  <Tab title="Operations">
    <Cards columns={2}>
      ...
      <Card title="Carrier Specific Guides"> <a href="https://docs.intersoftsapient.net/v4.02_4.03_Testing/docs/carrrier-specific-user-guides#/" target="_blank" rel="noopener noreferrer"></a>
