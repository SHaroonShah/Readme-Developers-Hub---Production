...
<button type="button" disabled="" aria-label="Previous Step" style="padding: 8px 16px; margin: 10px; border: none; border-radius: 4px; background-color: rgb(90, 62, 133); color: white; cursor: pointer;">Back</button>
</SimpleStepper>
