...
>
> 1. [enabled the label integration](https://docs.intersoftsapient.net/docs/integration-activation) _for DX Express_
> 2. _Obtained the [DX API credentials](https://docs.intersoftsapient.net/v4.03/docs/setting-up-dx-api-credentials)_
...
<Tabs>
  <Tab title="Via SAPIENT UI">
    ...
    <ToggleList>
      <ToggleListItem title="Step 1: Select the Shipping Accounts page " icon="list-ol">
      ...
      <ToggleListItem title="Step 2: Select option to add shipping account" icon="list-ol">
      ...
      <ToggleListItem title="Step 3: Enter account details" icon="list-ol">
      ...
      <ToggleListItem title="Step 4: Enter shipping account details" icon="list-ol">
      ...
      <ToggleListItem title="Step 5: Enter carrier details" icon="list-ol">
      ...
      <ToggleListItem title="Step 6: Save and add the shipping account" icon="list-ol">
...
> 📘 _Note_
>
> _Shipping account(s) can be added and managed via API. For more information, refer to the <Anchor label="API References" target="_blank" href="https://docs.intersoftsapient.net/reference/get_v4-shippingaccounts-dx">API References</Anchor> section._
