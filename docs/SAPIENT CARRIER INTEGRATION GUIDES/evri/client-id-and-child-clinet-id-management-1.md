...
## How to add child client department to parent shipping account
...
<ToggleList>
  <ToggleListItem title="1. Navigate to the Shipping Accounts page">
  ...
  <ToggleListItem title="Step 3: Select option to add child client departments">
  ...
  <ToggleListItem title="Step 4: Add a child client department">
  ...
  <ToggleListItem title="Step 5: Enter child client department details">
  ...
  <ToggleListItem title="Step 6: Save the child client department">
    After entering all the required information, select ![](https://files.readme.io/0db8af6a214edf8388a6fe90740721c220967596413a59cddb80e7cc96b07b19-Add_child_client_department_button_2.png).
  </ToggleListItem>
</ToggleList>
