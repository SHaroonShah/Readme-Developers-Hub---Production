...
<Accordion title="Step 1: Select the Integrations page" icon="fa-arrow-right">
...
<Accordion title="Step 2: Select the LABELS integration for An Post" icon="fa-arrow-right">
...
<Accordion title="Step 3: Configure the LABELS integration" icon="fa-arrow-right">
...
<Accordion title="Step 4: Add a barcode range" icon="fa-arrow-right">
...
<Accordion title="Step 5: Enter barcode range details" icon="fa-arrow-right">
