...
<ToggleList>
  <ToggleListItem title="Step 1: Select Integrations" icon="fa-arrow-right">
...
<br />
  <ToggleListItem title="Step 2: Select LABELS for An Post" icon="fa-arrow-right">
...
***
  ...
  <ToggleListItem title="Step 3: Configure the LABELS integration" icon="fa-arrow-right">
...
***
  ...
  <ToggleListItem title="Step 4: Add a barcode range" icon="fa-arrow-right">
...
***
  ...
  <ToggleListItem title="Step 5: Enter barcode range details" icon="fa-arrow-right">
