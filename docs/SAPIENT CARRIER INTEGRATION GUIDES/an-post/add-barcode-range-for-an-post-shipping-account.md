...
<ToggleList>
  <ToggleListItem title="1. Select the Integrations page" icon="fa-arrow-right">
  ...
  <ToggleListItem title="2. Select the LABELS integration for An Post" icon="fa-arrow-right">
    In the list of carrier integrations that appears, next to An Post, select **LABELS**.

    <Image align="center" border={true} src="https://files.readme.io/73206c9fcae539ce5f93c960a128ac24b243ce68ee47e2102c15b2f08b6cc098-Accessing_an_post_label_integration.png" alt="Accessing labels integration" />
  ...
  <ToggleListItem title="3. Configure the LABELS integration" icon="fa-arrow-right">
    On the page that opens, under the **Available Integrations** block, in the **LABELS** section, select **CONFIGURE**.

    <Image align="center" border={true} src="https://files.readme.io/96f212ec23ed9c9033e295654543c4d4571a1189801f779bfbcfa2a9d2b20ed5-Configuring_an_post_labels_integration.png" alt="Configuring labels integration" />
  ...
  <ToggleListItem title="4. Add a barcode range" icon="fa-arrow-right">
    In the **Configure ANPOST** page that opens, select the **Barcode Ranges** tab and click ![](https://files.readme.io/d48a6a38086006b7b6e7e4edaaabed26a14571fe2fe075d2749bd142ac31f03f-Add_barcode_range_button.png).

    <Image align="center" border={true} src="https://files.readme.io/96e322d52aad201fb3c72d60c68ff6c2796ceb6b72665a463abae2e96b8f4082-Selecting_an_post_barcode_range_tab.png" alt="Accessing option to add barcode range" />
  ...
  <ToggleListItem title="5. Enter barcode range details" icon="fa-arrow-right">
    In the **Barcode Range Details** form that opens, enter the necessary information as explained in the following table.

    <Image align="center" border={true} src="https://files.readme.io/c796a68058d34fce826f5fd4af9b779690559fa07e009194c9c2bbcc443b842a-Adding_an_post_barcode_range.png" alt="Entering barcode range details" />
