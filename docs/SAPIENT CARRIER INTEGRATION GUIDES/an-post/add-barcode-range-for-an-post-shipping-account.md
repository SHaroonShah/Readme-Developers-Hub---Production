...
<Accordion title="2. Select the LABELS integration for An Post" icon="fa-arrow-right">
...
<Accordion title="3. Configure the LABELS integration" icon="fa-arrow-right">
...
<Accordion title="4. Add a barcode range" icon="fa-arrow-right">
...
<Accordion title="5. Enter barcode range details" icon="fa-arrow-right">
