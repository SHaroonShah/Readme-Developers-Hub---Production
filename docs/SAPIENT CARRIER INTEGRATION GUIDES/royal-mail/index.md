...
* **Ship To Destinations**: Primarily, the carrier is used for domestic shipping. However, users can also send <Glossary>shipments</Glossary> to Europe (EU) and the Rest of the World (<Glossary>ROW</Glossary>).
