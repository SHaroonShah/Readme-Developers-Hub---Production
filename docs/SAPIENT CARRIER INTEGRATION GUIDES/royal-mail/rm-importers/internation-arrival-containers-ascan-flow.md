...
Based on your business requirements, you may proceed with any of the preceding options and ship as needed.

<Tabs>
  <Tab title="Option 1: ContainerId is known">
    Create the shipments and allocate the already created container when the `ContainerId` is known.
  </Tab>
  <Tab title="Option 2: ContainerId is unknown">
    Create the shipments first, then create the container, and later allocate your shipments to the container.
  </Tab>
</Tabs>

The following flows explain the entire journey of the UK arrival containers.

<Accordion title="Create shipment and allocate container when the ContainerId is known" icon="fa-solid fa-1">
...
<Accordion title="Create shipment when ContainerId is unknown and allocating them later" icon="fa-solid fa-2">
...
<Accordion title="Manifest container" icon="fa-solid fa-3">
...
<Cards columns={4}>
  <Card title="Set up International Arrival Containers barcode ranges" href="https://docs.intersoftsapient.net/docs/add-barcode-range-for-international-arrival-containers#/" icon="fa-solid fa-barcode-read" target="_blank">
