...
In SAPIENT, you can add tracking accounts for Royal Mail to enhance visibility, improve customer interactions, and streamline logistics operations.
...
> 🚧 _Important_
>
> _Prior to adding a Royal Mail tracking account, complete the following prerequisites:_
>
...
> 3. _Set up your <Glossary>tracking webhook</Glossary>. For more information, refer to [Create tracking webhook](https://docs.intersoftsapient.net/docs/create-tracking-webhook). This is a one-time activity._

  </Column>
</Columns>

To add a tracking account for Royal Mail in SAPIENT, follow the steps below.

<Accordion title="Step 1: Navigate to Tracking Accounts" icon="fa-route">
...
<Accordion title="Step 2: Select Add Tracking Account" icon="fa-plus-circle">
...
<Accordion title="Step 3: Fill in the tracking account details" icon="fa-file-alt">
...
<Accordion title="Step 4: Submit the tracking account" icon="fa-check">
