...
If you want to enable your customers to have their returns collected from their homes, you can create a Royal Mail shipment using one of Royal Mail's return services, ITA, ITB, <Glossary>TSN Tracked Returns 24</Glossary> or <Glossary>TSS Tracked Returns 48</Glossary>. Please ensure to meet [all the requirements](https://docs.intersoftsapient.net/docs/royal-mail-returns) when creating a returns shipment. You can then request a Royal Mail collection for the <Glossary>shipment</Glossary>.
