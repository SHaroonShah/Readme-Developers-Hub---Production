...
<Accordion title="Accessing PUDO Locations via SFTP for local collect">
  ...
  <Callout icon="💡" theme="default">
    ...
    *The file is generated on a daily basis and it is recommended to get the latest PUDO file after our last schedule run at 7:30 AM (BST). To learn more about the file data, refer to the following example file:*
