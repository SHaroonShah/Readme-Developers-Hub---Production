            ...
            return (
              <button
                ...
                className={`
                 ...
                 text-black hover:text-yellow-500 dark:hover:text-yellow-600
                 ${isActive && 'text-white-700 -mb-1 border-b-1 border-gray-600 dark:text-yellow-700 dark:border-white'}`}
