            ...
            return (
              <button
                ...
                className={`
                 ...
                 text-yellow-500 hover:text-yellow-500 dark:hover:text-yellow-300
                 ${isActive && 'text-gray-700 -mb-1 border-b-1 border-gray-600 dark:text-yellow dark:border-white'}`}
