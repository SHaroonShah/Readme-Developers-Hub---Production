...
export const SimpleStepper = ({ children }) => {
  ...
  const indicatorStyle = (active) => ({
    ...
    lineHeight: '30px',
    borderRadius: '50%',
    backgroundColor: active ? '#ffb600' : '#ddd', // Updated active color for better contrast
  ...
  const buttonStyle = {
    ...
    border: 'none',
    borderRadius: '4px',
    backgroundColor: '#ffb600', // Updated button background for better contrast
    color: 'black',
    cursor: 'pointer',
  };
