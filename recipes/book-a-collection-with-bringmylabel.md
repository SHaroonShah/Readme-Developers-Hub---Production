...
namespace MCSS.CodeForRecipes.Recipes
{
		...
		using System;
		using System.Linq;
		public class BookCollectionWithBringMyLabel
    {
            ...
            var apiUrl = "API_URL";
                ...
                Items = new[]
                {
                    ...
                    new
                    {
						...
						// Book collection with the chosen collection date, and specify BringMyLabel = true
						// The "Bring My Label" option enables you to request that the label and any custom documents (if required) are printed by Royal Mail
						// and brought by the postal worker when making the collection.
						// The option is set to false by default, and if required needs to be included in your request.
						// BringMyLabel is available for both types of collection - with automatic collection date and selected collection date.
...
Store the timeslot data for reference or later use.
